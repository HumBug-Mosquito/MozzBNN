       ...
       # model_name = 'held_out_test_manual_v2_low_epoch'
        ...
        for root, dirs, files in os.walk(rootFolderPath):
            ...
            #             
                        ...
                        np.savetxt(os.path.join(root_out, output_filename) + '_BNN_step_' + str(step_size) + '_samples_' + str(n_samples) + '_'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--to_dash", help="Save predicted audio, video, and corresponding labels to same directory as dictated by dir_out.")
    ...
    write_output(rootFolderPath, audio_format, dir_out=dir_out, norm_per_sample=norm_per_sample, win_size=win_size, step_size=step_size, to_dash=to_dash)
